...
def demo(screen, scene):
    scenes = [Scene(
        [LandingView(screen=screen, help_text=HELP_TEXT)],
        -1,
        name="Landing"),
        Scene(
        [ListBoxView(screen=screen, content=model, next_screen="Flag SubCategories", previous_screen="Landing",
                     screen_title="Flag Categories", help_text=HELP_TEXT)],
        -1,
...
structure_path = "../documentation/rsync_doc/doc.json"
model = DataModel(structure_path)
selected_value = "How to Copy It:Links and Shortcuts"
